...
% XXX: Formally, if $v$ is the value of the proposal, $\exists (p, v) \in {
...
If the Proposer receives \msg{Promise} replies from a quorum of acceptors, $Q$,
...
complete and some not to. In this example, we may have the constraint $A = 10\times B$. If B was
