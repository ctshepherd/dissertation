...
Lamport tried to disprove the existance of a protocol with its properties. Instead, he ended up
developing Paxos.
...
phase, then the operation has not been commited, as no node can have moved to the finalise phase
