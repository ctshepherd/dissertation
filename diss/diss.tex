...
\subfigure[Latency for 10 Nodes]{
...
Firstly I measured the contention in a network with 5 nodes. Figure~\ref{fig:lat-10} shows how the
...
\begin{figure}[Hp]
\centering
\subfigure[Throughput for 10 Nodes]{
