...
\begin{center}
\Huge
{\bf PFS: A Distributed Peer-to-Peer Filesystem based on the Paxos protocol} \\
\vspace*{5mm}
...
Project Title:      & \bf PFS: A Distributed Peer-to-Peer Filesystem based on the Paxos protocol  \\
Examination:        & \bf Diploma in Computer Science, July 2013        \\
